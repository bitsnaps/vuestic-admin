<template>
  <div class="collapse-page">
    <div class="row">
      ...
      <div class="flex xs12">
        <va-card>
          <va-card-title>{{ $t("app.collapse.collapseWithBackground") }}</va-card-title>
          <va-card-content>
            <va-accordion v-model="colorAccordionValue">
              <va-collapse
                class="mb-4"
                :header="$t('app.collapse.firstHeader')"
                color="success"
                color-all
              >
                <div class="pa-3">
              ...
              <va-collapse
                :header="$t('app.collapse.secondHeader')"
                color="warning"
                color-all
              >
                <div class="pa-3">
